...
function QrcodeProfile({UserF}) {
  ...
  const DownloadQRCode = () => {
    if (qrCodeRef.current) {
      ...
      if (canvas) {
        ...
        link.download = `${UserF.fullname}.Linkerfolio.png`;
        link.click();
      }
    }
  };
  ...
  const ShareQRCode = () => {
    if (navigator.share && qrCodeRef.current) {
      ...
      if (canvas) {
        canvas.toBlob((blob) => {
          const file = new File([blob], `${UserF.username}.Linkerfolio.png`, { type: 'image/png' });
          navigator.share({
            files: [file],
            title: 'QR Code',
                      ...
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          <QRCode
                            ...
                            includeMargin={true}
                            level="H"
                            imageSettings={"/LinkefolioLogo.png" ? {
