export const Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_US",
    site_name: "LinkerFolio",
    profile: {
      first_name: "Abdellah",
      last_name: "Edaoudi",
      username: "LinkerFolio",
      gender: "male",
    },
  },
  twitter: {
  ...
  additionalMetaTags: [
    ...
    },
    {
      ...
      content: "google-site-verification=AKe-FSZeT2tt0eIiD4oTfur9DrT_1WgN9vhJXjnD6Go",
    },
    {
  ...
  schema: {
    ...
    "url": "https://linkerfolio.vercel.app",
    "sameAs": [
      "https://web.facebook.com/profile.php?id=61566514480968&__tn__=<%2Cd", // تم تصحيح الرابط هنا
